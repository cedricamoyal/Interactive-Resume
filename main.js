...
var graphNodes = function () {
  	...
  	var dataset1 = {
          ...
          {name1:"A Dynamic App",name2:"with React", class: "colorType2", radius: 55,
              description: 'Welcome to the <span class="purplePlanets">Dynamic World</span> my first project with React. This one page application illustrates the power and the speed of React.<br><br>Where do you want to travel?<br>Start typing the name of the country that you wish to visit in the input, enjoy the real-time search, click on the visits and check your trip on the map.<br> Do not hesitate to use the reminder tool on the top right corner of your screen to take notes.<br><br>This app is not connected to a database, it is front-end only. This code could be used to develop the dynamic version of the CRUD application that I previously made with Rails: Create Amazing Trips.<br><br>Link to the application:<a class="webDevAtag" href="https://cedricamoyal.github.io/project4React/dist/index.html" target="_blank"><span class="devicons devicons-github_alt"></span></a> <br>Link to the code:<a class="webDevAtag" href="https://github.com/cedricamoyal/project4React" target="_blank"><span class="devicons devicons-github_badge"></span></a>'},
